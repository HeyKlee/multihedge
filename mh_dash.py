...
/* ---- Mobile proportional responsive layer ---- */
:root{--space-1:clamp(6px,1.7vw,10px);--space-2:clamp(8px,2.2vw,14px);--space-3:clamp(12px,3vw,20px);--space-4:clamp(16px,4vw,28px);--radius-card:clamp(10px,2.8vw,16px)}
html,body{max-width:100%;overflow-x:hidden}img,svg,canvas,video{max-width:100%}.workspace,.card,.kpi,.modal-panel,.chat-panel,.widget-catalog{min-width:0}.card,.kpi{max-width:100%}.grid,.overview-grid,.hero{min-width:0}.scroll-wrap{max-width:100%;overscroll-behavior:contain}.scroll-wrap table{min-width:max-content}.header-actions>*{flex-shrink:0}
@media (max-width:1200px){
  .app-shell{width:100%;margin:0;border-radius:0;border-left:0;border-right:0;grid-template-columns:clamp(176px,20vw,210px) minmax(0,1fr)}
  .workspace{padding:clamp(20px,2.4vw,28px) clamp(16px,2.6vw,28px) 88px}
  .hero{grid-template-columns:repeat(2,minmax(0,1fr));gap:var(--space-2)}
  .grid,.overview-grid{gap:var(--space-2)}
  .grid>.card{grid-column:span 6}.span-3,.span-4{grid-column:span 6}.span-5,.span-6,.span-7,.span-8{grid-column:span 6}.span-12,.grid>.card.widget-wide{grid-column:1/-1}
  .wallet-tabs{grid-template-columns:repeat(3,minmax(0,1fr))}
}
@media (max-width:860px){
  body{font-size:clamp(13px,3.5vw,15px);line-height:1.45;overflow-x:hidden;touch-action:manipulation}
  .app-shell{display:block;width:100%;min-height:100svh;margin:0;border:0;border-radius:0;overflow:visible;background:var(--bg)}
  .sidebar{position:sticky;top:0;width:100%;height:auto;max-height:none;padding:var(--space-2) var(--space-2) calc(var(--space-2) - 2px);border-right:0;border-bottom:1px solid var(--border);z-index:30}
  .brand{padding:0 2px var(--space-2);gap:8px}.brand-mark{width:clamp(30px,8vw,36px);height:clamp(30px,8vw,36px);border-radius:9px;font-size:clamp(11px,3vw,14px)}.brand-name{font-size:clamp(15px,4vw,18px)}.brand-sub,.environment,.sidebar-foot,.nav-group{display:none!important}
  .tabs{display:flex;flex-direction:row;gap:6px;overflow-x:auto;overflow-y:hidden;scroll-snap-type:x proximity;padding:0 var(--space-2) 2px;-webkit-overflow-scrolling:touch;scroll-padding-inline:var(--space-2)}.tabs button{flex:0 0 auto;width:auto;min-height:42px;padding:8px 12px;border-radius:12px;font-size:clamp(12px,3.4vw,14px);scroll-snap-align:start;white-space:nowrap}.tabs button.active{box-shadow:inset 0 -3px 0 var(--accent)}.nav-icon{display:none!important}
  .workspace{padding:var(--space-3) var(--space-2) calc(78px + env(safe-area-inset-bottom,0px));width:100%;overflow:hidden}.workspace-header{position:relative;top:auto;display:flex;flex-direction:column;align-items:stretch;gap:var(--space-2);margin-bottom:var(--space-2);padding-bottom:var(--space-2);background:transparent}.workspace-header h1{font-size:clamp(20px,6.2vw,28px);line-height:1.05}.workspace-header p{font-size:clamp(11px,3.25vw,13px);margin-top:5px;max-width:100%}.page-eyebrow{font-size:clamp(9px,2.7vw,10px)}.header-actions{width:100%;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;justify-content:stretch}.header-actions .toolbar-btn,.header-actions .status-pill{width:100%;min-width:0;text-align:center;justify-content:center}.header-actions .status-pill{grid-column:1/-1;white-space:normal;line-height:1.25;padding:8px}.update-state{display:none!important}
  .ticker{display:none!important}.hero{grid-template-columns:1fr;gap:var(--space-2);margin-bottom:var(--space-2)}.kpi{padding:var(--space-3);border-radius:var(--radius-card);margin-bottom:0}.kpi .lbl{font-size:clamp(9px,2.7vw,10px);padding-right:0}.kpi .val{font-size:clamp(20px,7vw,26px);line-height:1.12}.kpi-detail{font-size:clamp(11px,3.1vw,13px)}
  .grid,.overview-grid{display:grid!important;grid-template-columns:1fr!important;gap:var(--space-2)}.grid>.card,.overview-grid>.card,.span-3,.span-4,.span-5,.span-6,.span-7,.span-8,.span-12,.grid>.card.widget-wide{grid-column:1/-1!important}.card{padding:var(--space-3);margin-bottom:0;border-radius:var(--radius-card);overflow:hidden}.card h3{font-size:clamp(13px,3.9vw,16px);line-height:1.2;margin-bottom:var(--space-2);padding-right:44px}.widget-tools{right:8px;top:8px}.widget-report-btn{right:8px;top:8px;width:30px;height:30px}.toolbar-btn{min-height:42px;padding:8px 10px;font-size:clamp(11px,3.2vw,13px)}
  canvas{height:clamp(180px,52vw,280px)!important;min-width:0}#mkcv,#gld-cv{height:clamp(240px,72vw,380px)!important;min-height:220px}.chart-flex{flex-direction:column;gap:var(--space-2)}.chart-legend{min-width:0;width:100%;font-size:11px}.tfbar{gap:6px;overflow-x:auto;flex-wrap:nowrap;padding-bottom:2px}.tfbar button{flex:0 0 auto;min-height:40px;padding:8px 10px;font-size:11px}
  table{font-size:clamp(10.5px,2.9vw,12px)}th,td{padding:8px 9px}.scroll-wrap{max-height:clamp(180px,48vh,360px);min-height:min(180px,38vh);overflow:auto;-webkit-overflow-scrolling:touch}.wallet-tabs{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.wallet-summary{width:100%;justify-content:flex-start}.wallet-summary span{font-size:11px;padding:7px 8px}.wallet-tab{min-height:58px;padding:8px}.wallet-tab b{font-size:clamp(14px,4.2vw,18px)}.wallet-tab small,.wallet-tab span{font-size:10px}.xora-sum-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.gate-row{grid-template-columns:1fr;align-items:start;gap:4px}.gate-meta{text-align:left;white-space:normal}.metric-xl{font-size:clamp(22px,7vw,31px)}
  .modal-overlay{align-items:flex-end;justify-content:center}.modal-panel{width:100%;max-width:100%!important;max-height:min(88svh,720px);border-radius:18px 18px 0 0;padding:var(--space-3);overflow:auto}.settings-row{align-items:flex-start;flex-direction:column;gap:7px}.settings-row select,.settings-row input[type=color],.settings-row input[type=range],.issue-modal-field select,.issue-modal-field input[type=file]{width:100%;min-height:40px}.issue-modal-field textarea{min-height:130px;font-size:14px}.widget-catalog{inset:auto 0 0 0;left:0;top:auto;transform:none;width:100%;max-height:82svh;border-radius:18px 18px 0 0;padding:var(--space-3)}.widget-catalog-grid,.widget-catalog .wc-type-grid{grid-template-columns:1fr}.widget-catalog .wc-item{min-height:54px;padding:10px var(--space-2);font-size:12px}.widget-catalog .wc-item b{font-size:12px}.widget-catalog .wc-item small{font-size:10.5px}
  .chat-panel{left:var(--space-2);right:var(--space-2);bottom:calc(80px + env(safe-area-inset-bottom,0px));width:auto;max-height:calc(100svh - 104px - env(safe-area-inset-bottom,0px));border-radius:16px;padding-bottom:env(safe-area-inset-bottom,0px)}.chat-msgs{min-height:180px}.chat-input{padding:8px;gap:6px}.chat-input input{min-height:42px;font-size:14px}.chat-input button{min-height:42px}.xora-pet{right:12px;bottom:calc(12px + env(safe-area-inset-bottom,0px));width:56px;height:60px;min-width:56px;min-height:60px}.pet-bubble{right:74px!important;left:auto!important;max-width:calc(100vw - 92px);font-size:11px}
  .bottom-actions{position:static;transform:none;width:100%;margin:var(--space-3) 0 0;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.bottom-actions button{min-height:44px;font-size:12px}.free-edit #tab-panels,.free-edit .hero,.free-edit #coin-wrap{min-height:560px}.free-edit .card,.free-edit .kpi{max-width:calc(100vw - 40px);min-width:min(170px,calc(100vw - 40px))}.free-grab{height:34px}.free-resize{width:34px;height:34px}.build-toolbar{left:8px;right:8px;bottom:8px;width:auto;transform:none;opacity:1;padding:8px}.build-toolbar.open{transform:none}.build-mode .card,.build-mode .kpi{padding-top:44px}.tile-resize{display:none!important}
}
@media (max-width:420px){
  .workspace{padding-left:10px;padding-right:10px}.header-actions{grid-template-columns:1fr}.card,.kpi{padding:12px}.card h3{padding-right:38px}.wallet-tabs,.xora-sum-grid{grid-template-columns:1fr}.scroll-wrap{max-height:320px;min-height:min(160px,36vh)}th,td{padding:7px 8px}.tabs button{min-height:40px;padding:7px 10px}.toolbar-btn{min-height:40px}.modal-panel,.widget-catalog{padding:14px}.bottom-actions{grid-template-columns:1fr}
}
